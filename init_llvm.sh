...
add-apt-repository "deb http://apt.llvm.org/${UBUNTU_CODENAME}/ llvm-toolchain-${UBUNTU_CODENAME}-7 main" && apt update
apt install --no-install-recommends -y llvm-7 llvm-7-dev clang-7 libclang-7-dev lldb-7 clang-tools-7
